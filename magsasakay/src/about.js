      ...
      >
        <div>
            ...
            <div className="absolute top-40 left-0 right-0">
              ...
              <div className="box-container p-2 text-left font-semibold text-[18px] whitespace-normal">
                ...
                >
                  ...
                  journeys, enhances their daily lives, and contributes to a
                  more sustainable and connected world. We are committed to
                  delivering accurate, accessible, and innovative route
                  solutions that prioritize user convenience, safety, and
                  environmental responsibility. Through our platform, we aim to
          ...
          <p className="text-white font-Montserrat p-4 ml-6 text-left font-normal md:text-lg text-[15px]">
            ...
            fostering collaboration. Rainer Mayagma, a results-driven project
            manager, ensures projects are delivered on time and within budget
            with his exceptional organizational skills. John Luis Magtoto, a
            highly skilled developer, tackles coding challenges with finesse,
            delivering clean and efficient solutions. Kurt Matthew Amodia brings
            a passion for crafting elegant software solutions, adapting
            seamlessly to diverse project requirements. Zyrex Djewel Ganit,
            known for his relentless work ethic, prioritizes project success
            above all else, infusing the team with his uplifting spirit.
            Together, we're committed to simplifying journeys and creating a
            more connected world through our commute app.
          </p>
