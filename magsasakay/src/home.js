                ...
                <div className= "px-4 lg:px-14 max-w-screen-2xl mx-auto min-h-screen h-screen mt-[-100px]">
                    <Carousel className= "w-full mx-auto rounded-2xl">
                        ...
                        gap-12"> 
                            ...
                            <div className= "md:w-1/2 z-10 relative ml-[55px]">
                        ...
                        gap-12">
                            ...
                            <div className= "md:w-1/2 ml-[55px]">
                                <h1 className="text-5xl font-semibold mb-4 text-white md:w-3/4 leading-snug">
                                    Discover
                        ...
                        gap-12">
                            ...
                            <div className= "md:w-1/2 ml-[55px]">
                                ...
                                <p className="text-white text-base mb-8">
                                Come and meet the team behind the project 'Magsasakay'! 
                                We're a group of passionate individuals dedicated to revolutionizing 
                                the way people commute. Together, we're shaping the future of transportation,
                                one innovative idea at a time. Get to know us, our mission, and our journey
