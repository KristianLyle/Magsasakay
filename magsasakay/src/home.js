        ...
        <div className="container h-screen w-[150%] relative z-10">
          <div className="text-white">
            ...
            <p className='font-Montserrat font-regular text-[20px] ml-[10px]'>
              ...
              and explore <br /> top-rated traveler-recommended restaurants in
              the city. Plan your journey effortlessly, <br /> read honest
              reviews. Your guide to travel and dining adventures. Start
              exploring now!
            </p>{' '}
            <br /> <br /> <br />
